# This is an adjusted script that was used to test that the ip feature was working
# The difference is in the "if __name__ == "__main__":" part at the very bottom
# Also a test JSON file was created to be purposefully suspicious, that example script is in the "Sus_JSON" file in this repo
